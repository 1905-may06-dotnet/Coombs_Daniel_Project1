...
namespace PizzaBoxData
{
    public static class Mapper
    {
        ...
        public static Pizza Map(OrdersPlaced order) => new Pizza
        {
            ...
            Size = order.Size,
            Crust = order.Crust,
            Toppings = new List<string>() { order.Topping1, order.Topping2, order.Topping3, order.Topping4, order.Topping5},
        ...
        public static OrdersPlaced Map(Pizza order) => new OrdersPlaced
        {
            ...
            Size = order.Size,
            Crust = order.Crust,
            Topping1 = order.Toppings[0],
            Topping2 = order.Toppings[1],
            Topping3 = order.Toppings[2],
            Topping4 = order.Toppings[3],
            Topping5 = order.Toppings[4],
